...
$ridinfo=veri_rid($_COOKIE['rid'],$con);
  ...
  if($userinfo['admin']==0){
	...
	$sql="SELECT * FROM  `baomingbiao` WHERE (( `zhiyuanyi` =  '$zhiyuan' AND  `zhiyuanyi2` =  '$zhiyuan2') OR ( `zhiyuaner` =  '$zhiyuan' AND `zhiyuaner2` =  '$zhiyuan2') OR ( `zhiyuansan` =  '$zhiyuan' AND  `zhiyuansan2` =  '$zhiyuan2')) AND `season` = '1902'";
	...
	if($resultbefore)
	{
		...
		$json[0] = Array("id" => "plan_title", "html" => "本部门招新报名数据导出");
